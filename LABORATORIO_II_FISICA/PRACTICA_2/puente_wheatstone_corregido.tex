...
\subsection{Cálculo de la Tensión de Thévenin $V_{\mathrm{th}}$}
...
\subsection{Cálculo de la Resistencia de Thévenin ($R_{th}$)}
...
\]
En la mayoría de las aplicaciones de sensores modernos, se utiliza un amplificador con una impedancia de entrada muy alta en lugar de un galvanómetro, por lo que la corriente $I_G$ es prácticamente nula y la tensión medida es directamente $V_{\mathrm{th}}$.
