...
\hypersetup{
    ...
    linkcolor=blue,
    urlcolor=cyan,
    pdftitle={Plan de Trabajo: Introducción a la Electrónica},
}

\title{\textbf{Plan de Trabajo de 10 Semanas:\\ Introducción a la Electrónica}}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Lectura Activa:} No solo leas, sino toma notas, subraya y resume los conceptos clave.
    \item \textbf{Resolución de Problemas:} La electrónica se aprende haciendo. Dedica tiempo a resolver los 'Cuestiones y problemas' al final de cada capítulo. Los 'Resultados de problemas' (p. 449-455) te serán útiles para verificar tus soluciones.
    \item \textbf{Simulación (SPICE/DroidTesla):} Si tienes acceso a un simulador como SPICE (Apéndice B), úsalo para verificar tus análisis y entender mejor el comportamiento de los circuitos, especialmente en los capítulos donde se menciona explícitamente.
    \item \textbf{Flexibilidad:} Este es un plan ambicioso. Si un tema te resulta particularmente difícil, no dudes en dedicarle más tiempo, incluso si eso significa ajustar las semanas siguientes.
    \item \textbf{Revisión Constante:} Repasa periódicamente los conceptos de semanas anteriores para consolidar el conocimiento.
\end{itemize}
...
\end{itemize}
\textbf{Objetivos:} Dominar las leyes fundamentales de los circuitos, el cálculo de magnitudes eléctricas y las técnicas básicas de análisis para circuitos resistivos.\\
\textbf{Actividades:}
\begin{itemize}
...
\end{itemize}
\textbf{Objetivos:} Entender los teoremas de circuitos lineales y la importancia de las fuentes dependientes en el modelado de dispositivos.\\
\textbf{Actividades:}
\begin{itemize}
...
\end{itemize}
\textbf{Objetivos:} Comprender el funcionamiento del A.O. y su modelado, así como introducirse a la simulación de circuitos con SPICE.\\
\textbf{Actividades:}
\begin{itemize}
...
\end{itemize}
\textbf{Objetivos:} Entender el concepto de capacidad, el comportamiento del condensador y el análisis de circuitos RC en el dominio del tiempo y la frecuencia.\\
\textbf{Actividades:}
\begin{itemize}
...
\end{itemize}
\textbf{Objetivos:} Comprender el concepto de inductancia, el comportamiento de la bobina y el transformador, y el análisis de circuitos RL.\\
\textbf{Actividades:}
\begin{itemize}
...
\textbf{Capítulos:}
\begin{itemize}
    \item \textbf{6. El diodo. Circuitos con diodos} (Secciones 6.1-6.3, p. 149-161): El diodo (conceptos básicos, en continua y baja frecuencia, rectificador).
\end{itemize}
\textbf{Objetivos:} Entender el diodo ideal y real, sus modelos y características i-v, y analizar circuitos rectificadores de media onda y onda completa.\\
\textbf{Actividades:}
\begin{itemize}
...
\textbf{Capítulos:}
\begin{itemize}
    \item \textbf{6. El diodo. Circuitos con diodos} (Secciones 6.4-6.8, p. 178-198): El diodo zener, régimen dinámico (transitorios), pequeña señal, consideraciones térmicas, análisis con SPICE.
\end{itemize}
\textbf{Objetivos:} Comprender el diodo Zener y sus aplicaciones, el comportamiento del diodo en transitorios y pequeña señal, y el impacto de la temperatura.\\
\textbf{Actividades:}
\begin{itemize}
...
\textbf{Capítulos:}
\begin{itemize}
    \item \textbf{7. El transistor bipolar} (Secciones 7.1-7.5, p. 205-244): Conceptos básicos, en continua y baja frecuencia (curvas características, análisis DC), como interruptor, como amplificador (conceptos básicos, punto de trabajo, márgenes dinámicos).
\end{itemize}
\textbf{Objetivos:} Entender la estructura y funcionamiento del BJT, su polarización en DC y los principios de amplificación.\\
\textbf{Actividades:}
\begin{itemize}
...
\textbf{Capítulos:}
\begin{itemize}
    \item \textbf{7. El transistor bipolar} (Secciones 7.6-7.10, p. 246-277): Modelos en pequeña señal (híbrido en $\pi$, parámetros h), etapas elementales (emisor común, seguidor, base común), par acoplado por emisor, limitaciones, análisis con SPICE.
\end{itemize}
\textbf{Objetivos:} Dominar los modelos de pequeña señal del BJT y analizar las diferentes configuraciones de amplificadores.\\
\textbf{Actividades:}
\begin{itemize}
...
\end{itemize}
\textbf{Objetivos:} Comprender el funcionamiento del MOSFET y sus aplicaciones, y obtener una visión general de otros dispositivos semiconductores importantes, así como de la física y tecnología de fabricación.\\
\textbf{Actividades:}
\begin{itemize}
