...
Este documento define un sistema de **arquitectura de tres capas** diseñado para optimizar la interacción entre la inteligencia artificial y la ejecución técnica, separando la lógica probabilística de la **ejecución determinista**. El contexto de este proyecto es un **espacio de trabajo multidisciplinario** que abarca desde la programación (Python, C, Rust, Verilog), configuración de servidores y desarrollo IoT, hasta diseño de hardware abierto (EDA), desarrollo de smart contracts en Solana (Rust), implementación de sistemas RAG y la revisión y generación de material académico en LaTeX.
