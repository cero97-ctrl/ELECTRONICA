...
\begin{document}
\bandaTitulo[verdeTurquesa]{Prueba de Estilo Mejorado}{Elementos nuevos del PREAMBULO\_INFOGRAFIA}
\section{Contenido}
\subsection{Subsección}
\subsubsection{Subsubsección}
\begin{cajaRecuerda} Recuerda que el codigo debe ir bien escrito. \end{cajaRecuerda}
\begin{cajaConcepto} Concepto clave de electronica. \end{cajaConcepto}
\begin{cajaEjemplo}
\begin{lstlisting}
python3 --version
\end{lstlisting}
\end{cajaEjemplo}
\begin{cajaEjercicio} Ejercicio 1 \facil \end{cajaEjercicio}
\begin{cajaEjercicio} Ejercicio 2 \intermedio \end{cajaEjercicio}
\begin{cajaReto} Reto 1 \dificil \end{cajaReto}
