...
\begin{itemize}
    ...
    \path{flujo_empaquetar_dataset.py}, \path{flujo_publicar_hf.py} y tres
...
\begin{itemize}
    ...
    \item Con menos de 10 muestras, todo el split va a train (val/test en 0); al
    acumular más datos, el particionado se reparte automáticamente.
\end{itemize}
