...
El Model Context Protocol (MCP) es un estándar abierto que permite conectar modelos de inteligencia artificial en la nube con recursos locales del sistema de forma segura. En este proyecto se han implementado cuatro servidores MCP locales desarrollados en Python mediante el framework \texttt{fastmcp}:
