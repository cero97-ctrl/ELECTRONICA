...
\hypersetup{
    ...
    urlcolor=cyan,
    pdftitle={Curso de Programación en Python para Estudiantes de Secundaria},
}
...
\newtcolorbox{cajaRecuerda}{
    colback=azulTitulo!5!white,
    colframe=azulTitulo,
    boxrule=0.8pt,
    arc=2mm,
    title={\textbf{Recuerda}},
    fonttitle=\small,
...
% Comando para indicar nivel de dificultad
\newcommand{\facil}{[\textcolor{green!50!black}{\textbf{Fácil}}]}
\newcommand{\intermedio}{[\textcolor{orange!80!black}{\textbf{Intermedio}}]}
\newcommand{\dificil}{[\textcolor{red!70!black}{\textbf{Difícil}}]}

\title{\textbf{Curso de Programación en Python}\\[6pt]
\large Para Estudiantes de Secundaria}
