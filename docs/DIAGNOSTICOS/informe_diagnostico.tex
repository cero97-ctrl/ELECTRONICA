...
\date{04 de July de 2026 a las 09:28}
...
Tiempo de Actividad (Uptime) & 3.4 horas \\ \hline
\end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{Memoria Disponible:} 0.11 GB
    \item \textbf{Porcentaje en Uso:} 96.9\%
\end{itemize}

\subsection{Almacenamiento (Disco Raíz)}
\begin{itemize}
    \item \textbf{Capacidad Total:} 233.18 GB
    \item \textbf{Espacio Usado:} 209.41 GB
    \item \textbf{Espacio Libre:} 11.86 GB
    \item \textbf{Porcentaje en Uso:} 89.8\%
\end{itemize}
