...
\begin{itemize}
    ...
    \item \textbf{\texttt{directives/}}: Capa 1 de la arquitectura. Contiene manuales de operación (SOPs) en formato YAML (13 archivos). Definen \textit{qué} debe hacerse (ej. \texttt{scrape\_website.yaml}, \texttt{git\_update.yaml}, \texttt{evaluar\_examen\_estudiante.yaml}, \texttt{evaluar\_practica\_laboratorio.yaml}).
    \item \textbf{\texttt{execution/}}: Capa 3 de la arquitectura. Contiene scripts deterministas en Python con una sola responsabilidad (5 archivos: \texttt{env\_diagnostic.py}, \texttt{scrape\_single\_site.py}, \texttt{evaluar\_examen.py}, \texttt{generar\_informe.py}, \texttt{alert\_user.py}).
